function SearchOrderCtrl($scope, $http, $timeout, $modal) {
    ...
    $scope.gotoPage = function (page) {
        ...
        $http.post(route.order.search, o).success(function (data) {
    ...
    $scope.viewItem = function (o) {
        ...
        utils.blockUI();
        $http.get(route.order.view, { params: params }).success(function (data) {
            if (data.success == 1) {
    ...
    $scope.deleteItem = function (o) {
        ...
        $http.post(route.order.del, x).success(function (data) {
            if (data.success == 1) {
