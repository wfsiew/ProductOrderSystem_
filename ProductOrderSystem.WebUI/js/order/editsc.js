var editurl = route.order.editsc;
...
function EditSCCtrl($scope, $http, $filter, $timeout, $window, $rootScope, uploadManager) {
    ...
    $scope.save = function () {
        ...
        $http.post(route.order.editsc, o).success(function (data) {
            if (data.success == 1) {
    ...
    $scope.variation = function () {
        ...
        $http.post(route.order.variation, o).success(function (data) {
            if (data.success == 1) {
    ...
    $scope.terminate = function () {
        ...
        $http.post(route.order.terminate, o).success(function (data) {
            if (data.success == 1) {
    ...
    $scope.withdraw = function () {
        ...
        $http.post(route.order.withdraw, o).success(function (data) {
            if (data.success == 1) {
                toastr.success(data.message);
                $scope.$parent.edit = false;
                if ($scope.model.urgent == 0)
